...
- [x] Configure Tailwind CSS v4 design tokens and variables
- [x] Set up entrypoint and React Router 7 setup

## Active Work Streams
- [x] Build core layouts and custom color system (index.css)
- [x] Implement responsive layout and navbar/footer navigation
